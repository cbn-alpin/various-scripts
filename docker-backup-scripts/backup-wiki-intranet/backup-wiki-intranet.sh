...
# Année : 2025
# Script de sauvegarde de l’instance Dokuwiki Intranet (wiki-intranet)
...
nom_sauvegarde="wiki-intranet"

# répertoire de travail
repertoire_sauvegarde="/home/admin/docker/wiki-intranet/backups"
date_du_jour=$(date +%F)
...
conteneur_site="wiki-intranet-dokuwiki"
conteneur_proxy="wiki-intranet-nginx"
